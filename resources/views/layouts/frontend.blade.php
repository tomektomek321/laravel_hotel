            ...
            <div class="container">
                ...
                <form method="POST"  class="form-inline">
                    ...
                    <div class="form-group">
                        ...
                        <input name="check_in" type="text" class="form-control datepicker" id="check_in" value="{{ old('check_in') }}" placeholder="Check in">
                    </div>

                    <div class="form-group">
                        <label class="sr-only" for="day_out">Check out</label>
                        <input name="check_out" type="text" class="form-control datepicker" id="check_out" value="{{ old('check_out') }}" placeholder="Check out">
                    </div>
                    <div class="form-group">
